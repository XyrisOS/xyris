 ...
 * @brief Limine's boot protocol header. This file was not
 * written by the Panix Contributors. Limine source code is
 * available at https://github.com/limine-bootloader/.
 * @version 1.0
 * @date 2020-12-10
 *
 * @copyright Copyright the Limine Contributors (c) 2020
 *
 */
